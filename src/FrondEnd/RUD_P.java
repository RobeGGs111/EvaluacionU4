...
public class RUD_P extends javax.swing.JFrame {
    ...
    public RUD_P(String user,int caja) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnSelect, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 350, -1, -1));
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
            if (!"".equalsIgnoreCase(txtNombreProducto.getText())) {
                ...
                if (productDetails.length > 0 && productDetails[0] != null) {
                    ...
                    txtNombreProducto.setText(productDetails[0]);

                    int categoriaID = Integer.parseInt(productDetails[1]);
                    cbxCategorias.setSelectedIndex(categoriaID - 1);

                    int cantidad = Integer.parseInt(productDetails[2]);
                    txtCantidad.setText(String.valueOf(cantidad));

                    double precio = Double.parseDouble(productDetails[3]);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (!txtNombreProducto.getText().isEmpty() &&
            ...
            try {
                ...
                int cantidad = Integer.parseInt(txtCantidad.getText()); // Validación implícita para números
                double precio = Double.parseDouble(txtPrecio.getText()); // Validación implícita para precios
                int id = cbxCategorias.getSelectedIndex();
                // Crear el objeto CProductos
                CProductos p = new CProductos();

                // Llamar al método update con los parámetros adecuados
                p.update(name, id, cantidad, precio);
                txtCantidad.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RUD_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
